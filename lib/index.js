...
module.exports = {
  ...
  //获取input utxo
  getInputUtxo: function getInputUtxo(fromAddress, amount) {
  ...
  //验证交易
  valiTransaction: function valiTransaction(transactionInfo) {
    return axios.post('http://114.116.4.109:8001/api/accountledger/transaction/valiTransaction', { "txHex": transactionInfo }).then(function (response) {
      return response;
    }).catch(function (error) {
      return { success: false, data: error };
    });
  ...
  //广播交易
  broadcast: function broadcast(transactionInfo) {
    return axios.post('http://114.116.4.109:8001/api/accountledger/transaction/broadcast', { txHex: transactionInfo }).then(function (response) {
      return response;
    }).catch(function (error) {
      return { success: false, data: error };
    });
