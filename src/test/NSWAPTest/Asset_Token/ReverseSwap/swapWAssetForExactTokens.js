...
call.callContract(pri, pub, fromAddress, assetChainId, assetId, {
    ...
    methodDesc: "",
    args: [
        5, 74, new BigNumber("50").shiftedBy(18).toFixed(), [process.env.wusdt, process.env.qqq], fromAddress, nuls.currentTime() + 300, 'tNULSeBaN5nddf9WkQgRr3RNwARgryndv2Bzs6'
    ]
}, 'swap usdt for qqq', multyAssets);
// 900.000988390779549621,60000.052887738874063295
// "0.752884336422843860","50.000000000000000000"
